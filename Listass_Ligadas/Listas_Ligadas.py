...
linked_list = ListaLigada[int]()

# Insert elements into the linked list
linked_list.insertar(10)
linked_list.insertar(20)
linked_list.insertar(30)
...
# Remove an element at a specific index from the linked list
